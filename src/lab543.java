...
public class lab543 {
    public static void main(String[] args) {
        int [] array1 = new int[5]; //створення 3 масивів
        int [] array2 = new int[5];
        int [] array3 = new int[5];
        for(int i = 0; i < array1.length; i++) {// Заповнення масивів випадковими числами з відрізку  [0; 5] та виведення
        ...
        int sum1 = 0;//Обчислення і виведення суми елементів кожного та середнього арифметичного для кожного масиву
